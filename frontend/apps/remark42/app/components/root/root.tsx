...
export class Root extends Component<Props, State> {
  ...
  onMakeRequestClick = () => {
    this.setState({ makeRequestActive: true });
  };
        ...
        <div className="root__main">
          {isSettingsVisible ? (
            ...
            <>
              ...
              {!isCommentsDisabled && (
                <>
                  {!this.state.makeRequestActive && (
                    <Button type="submit" className="button--makeRequest" onClick={this.onMakeRequestClick}>
                      Make a request
                    </Button>
                  )}
                  <div className={`comment-form__main ${!this.state.makeRequestActive && 'js-hidden'}`}>
                    <CommentForm
                      id={encodeURI(url || '')}
                      intl={this.props.intl}
                      theme={props.theme}
